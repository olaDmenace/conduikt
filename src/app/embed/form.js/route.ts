...
function buildEmbedJs(baseUrl: string): string {
  ...
  var BUTTON_STYLE =
    "display:block;width:100%;padding:12px 16px;background:#D9663A;color:#fff;border:0;border-radius:8px;font:600 14px/1 system-ui,-apple-system,sans-serif;cursor:pointer;letter-spacing:0.2px;";
  var ERROR_STYLE =
