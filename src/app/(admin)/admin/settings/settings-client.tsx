      ...
      <div className="rounded-xl border border-border-default bg-surface-1 p-6">
        ...
        <form onSubmit={handlePromote} className="flex gap-3">
          ...
          <button
            ...
            className="rounded-lg bg-gradient-to-br from-[#D4945A] to-[#C88550] px-5 py-2.5 text-[0.875rem] font-medium text-on-accent shadow-[0_0_20px_var(--accent-glow)] hover:brightness-110 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
