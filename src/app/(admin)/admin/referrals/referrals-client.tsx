    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-accent to-[#C88550] px-4 py-2.5 text-[0.875rem] font-medium text-surface-0 shadow-[0_0_20px_var(--accent-glow)] hover:brightness-110 transition-all"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-accent to-[#C88550] px-4 py-2 text-[0.875rem] font-medium text-surface-0 hover:brightness-110 transition-all disabled:opacity-50"
            >
