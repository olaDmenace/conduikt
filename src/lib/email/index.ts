        ...
        <table width="580" cellpadding="0" cellspacing="0" role="presentation" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e0db;">
          ...
          <tr>
            <td style="background:#1a1714;padding:28px 40px;">
              <p style="margin:0;font-size:20px;font-weight:700;color:#2F8C85;letter-spacing:-0.5px;">Conduikt</p>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <table cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:28px;width:100%;">
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #f0ebe5;">
                    <p style="margin:0;font-size:14px;color:#1a1714;"><span style="color:#2F8C85;font-weight:700;">01 /</span> &nbsp;Create a project</p>
                    <p style="margin:4px 0 0 32px;font-size:13px;color:#6a6560;">Connect your website to unlock all AI tools</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #f0ebe5;">
                    <p style="margin:0;font-size:14px;color:#1a1714;"><span style="color:#2F8C85;font-weight:700;">02 /</span> &nbsp;Run an SEO audit</p>
                    <p style="margin:4px 0 0 32px;font-size:13px;color:#6a6560;">Get a score and actionable findings in seconds</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:10px 0;">
                    <p style="margin:0;font-size:14px;color:#1a1714;"><span style="color:#2F8C85;font-weight:700;">03 /</span> &nbsp;Generate content</p>
              ...
              <table cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="background:#2F8C85;border-radius:8px;">
          ...
          <tr>
            <td style="background:#f9f6f2;padding:20px 40px;border-top:1px solid #e5e0db;">
              ...
              <p style="margin:8px 0 0;font-size:12px;"><a href="${appUrl}" style="color:#2F8C85;text-decoration:none;">conduikt.com</a></p>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td align="center">
        <table width="580" cellpadding="0" cellspacing="0" role="presentation" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e0db;">
          ...
          <tr>
            <td style="padding:36px 40px;">
              <p style="margin:0 0 8px;font-size:13px;font-weight:600;color:#2F8C85;text-transform:uppercase;letter-spacing:1px;">Plan Activated</p>
              ...
              <table cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:28px;width:100%;background:#f9f6f2;border-radius:8px;">
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <p style="margin:0;font-size:22px;font-weight:700;color:#2F8C85;">Conduikt ${planLabel}</p>
                  </td>
                </tr>
              </table>
              <table cellpadding="0" cellspacing="0" role="presentation">
          ...
          <tr>
            <td style="background:#f9f6f2;padding:20px 40px;border-top:1px solid #e5e0db;">
              <p style="margin:0;font-size:12px;color:#8a8176;line-height:1.6;">
                Manage your billing at <a href="${appUrl}/settings/billing" style="color:#2F8C85;text-decoration:none;">Settings &rarr; Billing</a>. Questions? Reply to this email.
              </p>
            </td>
          </tr>
        </table>
