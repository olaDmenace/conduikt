...
const buttonVariants = {
  primary:
    "bg-gradient-to-br from-[#2F8C85] to-[#1F6B66] text-on-accent shadow-[0_0_20px_var(--accent-glow)] hover:brightness-110 hover:scale-[1.02] active:brightness-95 active:scale-[0.98]",
  secondary:
